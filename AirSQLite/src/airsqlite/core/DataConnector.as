package airsqlite.core
{
	...
	{
		protected var config:ASLConfig;
		...
		private var tableStatements:Vector.<ASLStatement>;

		protected var currentStatement:ASLStatement;


		public function DataConnector(config:ASLConfig)
		{
			this.config			= config;
			...
			tableStatements 	= new Vector.<ASLStatement>();
		...
		private function openConnection():void
		{
			...
			// is AirSQLite configured for sync connection...
		...
		{			
			...
			for each(var tableStatement:ASLStatement in tableStatements)
			{
		 ...
		 */
		protected function initializeStatement(result:Function=null, status:Function=null):ASLStatement
		{
			var statement:ASLStatement = new ASLStatement(result, status);
		 ...
		 */
		protected function processStatement(statement:ASLStatement):*
		{
		 ...
		 */
		public function executeStatement(statement:ASLStatement):void
		{
		...
		private function instantData(statement:ASLStatement):*
		{
			if(config.asyncConnection == false)
			{
		...
		asl_unit_testing function testInitializeStatement():ASLStatement
		{
			return initializeStatement();
		}
		
		asl_unit_testing function testProcessStatement(statement:ASLStatement):*
		{
